...
# BME 6.565455428229438 h
# RE  6.591593721972571 h
# IE  7.023217429320018 h
...
for Ntp in range(0, iteration_limit+1):
    ...
    if Ntp < iteration_limit:
        ...
        for iAL in range(0, len(al_unique_index)):
            ...
            al_size[Ntp] = al_exploration_posterior.shape[0]
...
df = pd.DataFrame(al_size)        
df.to_csv(os.path.join(model_output_path+ r'/output','al_size.csv'))
