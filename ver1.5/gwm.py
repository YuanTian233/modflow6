...
def runmodelflow(sim_name, sim_ws,exe_name, gwfname,gwtname,hk, plot = False):            
    ...
    while plot is True:
        ...
        ax.scatter(point_loc[:, 1], point_loc[:, 0], marker='o',c='#000000')
        ...
        plt.scatter(point_loc[:, 1], point_loc[:, 0], marker='o',c='#000000')
...
def add_noise(true_meas, error_vals, ret_error=True):   
    ...
    rnd_noise = np.random.normal(size=(1, 10)) * total_error
