...
mc_size_AL = 50  #1_000      # sample size for output space which is also the Markov chain size
...
for Ntp in range(0, iteration_limit+1):
    ...
    if Ntp < iteration_limit:
        ...
        covariance_matrices_list = []
        al_exploration_list = []
        for i in range(0, len(al_unique_index)):
