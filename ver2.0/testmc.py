...
def runmodelflow(sim_name, sim_ws,exe_name, gwfname,gwtname,hk):

    
    
    # gwfname = "f" + sim_name # a name you can change for groundwater flow model
    # gwtname = "t" + sim_name # a name you can change for groundwater transport model
    ...
    return #waterhead, concentration
# with open("C:/Users/tian/Desktop/gp/testbal_mc/outputMC/waterhead.txt", "w") as f:
#     writer = csv.writer(f)
#     writer.writerows(waterhead)
